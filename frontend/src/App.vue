		...
		<main>
					...
					<div class="calculator-card">
						...
						<div class="results-section">
							...
							<div v-else class="empty-state">
								<p>Enter an amount above to see the conversions.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="information-section">
				<div class="container information-card">
					...
					<p>
						The traditional Ropani system is commonly expressed
						using Ropani, Aana, Paisa and Daam.
					</p>
